...
Implement Showcase project data system

## Tasks

- [ ] Decide data source (JSON file recommended)
- [ ] Create `data/showcase.json`
- [ ] Add project images
- [ ] Create `showcase-detail.tsx` modal component
- [ ] Replace existing hardcoded data
...
- [ ] Project list loads from JSON
- [ ] Category filter works
- [ ] Detail modal opens on project click
- [ ] Real project images are shown
